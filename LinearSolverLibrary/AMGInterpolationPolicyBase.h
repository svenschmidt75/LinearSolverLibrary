...
namespace LinearSolverLibrary_NS {
    ...
    private:
        virtual bool ComputeInterpolationOperator(LinAlg_NS::SparseMatrix2D const & m_, AMGStandardStrengthPolicy const & strength_policy, VariableCategorizer const & variable_categorizer) = 0;
