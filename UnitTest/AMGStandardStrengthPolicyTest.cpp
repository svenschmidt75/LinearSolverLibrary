...
TEST(AMGStandardStrengthPolicyTest, TestStrongConnectionsForRowForFivePointStencil) {
...
TEST(AMGStandardStrengthPolicyTest, TestStrongConnectionsForRowForNinePointStencil) {
    MatrixStencil<DirichletBoundaryConditionPolicy> stencil;
    stencil << -1, -4,  -1,
               -4, 20,  -4,
               -1, -4,  -1;
...
TEST(AMGStandardStrengthPolicyTest, TestStrongConnectionsForRowForNinePointStencil2) {
    MatrixStencil<DirichletBoundaryConditionPolicy> stencil;
...
TEST(AMGStandardStrengthPolicyTest, TestStrongConnectionsForStrongFFConnection) {
    SparseMatrix2D m{5};
